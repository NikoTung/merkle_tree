...
func TestNewMerkleTree(t *testing.T) {
	...
	assert.Equal(t, rootHash, fmt.Sprintf("%x", mTree.Root.Data), "Merkle tree root hash is correct")

	assert.Equal(t, n11.Data, mTree.Root.Right.Data, "The odd node hash is correct")
}
